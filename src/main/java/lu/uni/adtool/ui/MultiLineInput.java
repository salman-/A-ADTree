...
public class MultiLineInput extends JOptionPane {
  ...
  public static String showInputDialog(final String message, final String title,
    ...
    class GetData extends JDialog implements ActionListener {
      ...
      JTextArea comment    = new JTextArea(3, 10);
     
      JTextArea probability    = new JTextArea(3, 10);
      JTextArea asset    = new JTextArea(3, 10);
      JTextArea impact    = new JTextArea(3, 10);
      
      JTextArea threatAgent_means    = new JTextArea(3, 10);
      JTextArea threatAgent_motives    = new JTextArea(3, 10);
      JTextArea threatAgent_capabilities    = new JTextArea(3, 10);
      JTextArea threatAgent_opportunities    = new JTextArea(3, 10);
      ...
      public GetData() {
        ...
        mainPane.add(Box.createRigidArea(new Dimension(0, 10)));
        /*
        scroller = new JScrollPane(probability);
        scroller.setPreferredSize(new Dimension(200, 50));
        mainPane.add(scroller);
        mainPane.add(Box.createRigidArea(new Dimension(0, 10)));j */
